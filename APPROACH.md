...
"No of Items: 64", which matches the top-level count, a useful sanity check that no
item was skipped or double-counted.
...
- **Item 17.ii (cold-twisted/TMT reinforcement)**: the scan shows "1375.0/1500.0*" with
  ...
  the building's seismic zone metadata (page 1) lists "Zone I to IV and V", i.e. both
...
- **Embodied carbon (Bonus B2)**: matched by material keyword against the ICE Database
  v3 (Circular Ecology, Univ. of Bath, 2019), generic/average figures, since the BoQ
